...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print('\nThe model that has been used, was: {}'.format(model))
    print('\nNumber if Images: {}\nNumber of Dog Images: {}\nNumber of "Not-a" Dog Images: {}\n'.format(results_stats_dic['n_images'], results_stats_dic['n_dogs_img'], results_stats_dic['n_images'] - results_stats_dic['n_dogs_img']))
    pct_result_list = []
    for key in results_stats_dic:
        if key == 'pct_correct_dogs':            
            pct_result_0 = results_stats_dic.get('pct_correct_dogs')
        if key == 'pct_correct_breed':
            pct_result_1 = results_stats_dic.get('pct_correct_breed')   
        if key == 'pct_correct_notdogs':
            pct_result_2 = results_stats_dic.get('pct_correct_notdogs')
        if key == 'pct_match':
            pct_result_3 = results_stats_dic.get('pct_match')
    print(('% Correct Dogs: {} \n% Correct Breed: {} \n% Correct "Not-a" Dog: {} \n% Match Labels: {}').format(pct_result_0, pct_result_1, pct_result_2, pct_result_3))
